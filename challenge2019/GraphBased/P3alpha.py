...
class P3alphaRecommender():
    ...
    def fit(self, URM_train, topK=100, alpha=1., min_rating=0, implicit=True, normalize_similarity=False):
...
if __name__ == '__main__':
    ...
    Runner.run(recommender, True, find_hyper_parameters_P3alpha=True, evaluate_different_region_of_users=False, batch_evaluation=False)
