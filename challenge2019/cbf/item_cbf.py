...
if __name__ == '__main__':
    ...
    Runner.run(recommender, True, evaluate_different_type_of_users=False, find_hyper_parameters_item_cbf=False,
               find_weights_item_cbf=False, batch_evaluation=True, split='2080')
